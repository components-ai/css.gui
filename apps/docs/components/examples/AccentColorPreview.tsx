    ...
    <>
      ...
      sx={{ 
        ...
        <section sx={{
          ...
          <label>
            <styled.input autoFocus={true} type='text' value={JSON.stringify(styles)} styles={styles} style={{ appearance: 'none', border: '1px solid', borderRadius: '6px', padding: '12px', fontSize: '12px', width: '100%', boxSizing: 'border-box' }} />
          </label>
          <div sx={{pt:2}}>
            <label>
